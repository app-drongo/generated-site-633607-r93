// Enhanced by AI on 2025-08-11T00:19:56.960Z
// Section: hero
// Category: hero
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Streamline communication, boost productivity, and bring your team closer together with our intuitive collaboration platform.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link href="/features">
                <Button size="lg" variant="outline" className="text-base">
                  <Play className="mr-2 size-5" /> See Features
                </Button>
              </Link>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Teams using</p>
              <p className="text-sm">
                <span className="font-semibold">50K+</span> worldwide
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              <p className="text-xs text-muted-foreground">Productivity</p>
              <p className="text-sm">
                <span className="font-semibold">35%</span> increase
              </p>
            </div>
          </div>
        </div>
