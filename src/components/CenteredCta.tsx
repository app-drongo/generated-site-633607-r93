// Enhanced by AI on 2025-08-11T00:19:02.754Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of high-performing teams who have transformed their workflow with our collaborative platform. 
                Experience seamless communication and productivity today.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Full access for up to 5 team members
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Instant Onboarding</h3>
              <p className="text-sm text-muted-foreground">
